...
$catalogue = new MessageCatalogue('ca', array (
  ...
  array (
    ...
    'The video height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.' => 'L\'alçada del vídeo és massa gran ({{ height }}px). L\'alçada màxima permesa és {{ max_height }}px.',
    'The video height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.' => 'L\'alçada del vídeo és massa petita ({{ height }}px). L\'alçada mínima esperada és {{ min_height }}px.',
    'The video has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'El vídeo té massa pocs píxels ({{ pixels }}). La quantitat mínima esperada és {{ min_pixels }}.',
    ...
    'The video file is corrupted.' => 'El fitxer de vídeo està corrupte.',
    ...
    'Unsupported video codec "{{ codec }}".' => 'Còdec de vídeo no compatible «{{ codec }}».',
    'Unsupported video container "{{ container }}".' => 'Contenidor de vídeo no compatible "{{ container }}".',
    'The image file is corrupted.' => 'El fitxer d\'imatge està malmès.',
    'The image has too few pixels ({{ pixels }} pixels). Minimum amount expected is {{ min_pixels }} pixels.' => 'La imatge té massa pocs píxels ({{ pixels }}). La quantitat mínima esperada és {{ min_pixels }}.',
    ...
    'This filename does not match the expected charset.' => 'Aquest nom de fitxer no coincideix amb el joc de caràcters esperat.',
  ...
  array (
    ...
    'filter.label.contains_all' => 'conté tot',
