...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.U5ZDc.V'] ?? self::get_ServiceLocator_U5ZDc_VService($container)), ($container->privates['.service_locator.rv2PqbF'] ?? $container->load('get_ServiceLocator_Rv2PqbFService')), ['login' => [], 'api' => [], 'main' => [($container->privates['debug.security.authenticator.form_login.main'] ?? $container->load('getDebug_Security_Authenticator_FormLogin_MainService'))]], false);
