 ...
 */
class getSliderImageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SliderImageRepository' shared autowired service.
     *
     * @return \App\Repository\SliderImageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SliderImageRepository.php';

        return $container->privates['App\\Repository\\SliderImageRepository'] = new \App\Repository\SliderImageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
