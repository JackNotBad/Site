...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getApiPlatform_Symfony_IriConverterService($container)
    {
        ...
        $f = ($container->privates['api_platform.uri_variables.converter'] ?? self::getApiPlatform_UriVariables_ConverterService($container));

        if (isset($container->privates['api_platform.symfony.iri_converter'])) {
            return $container->privates['api_platform.symfony.iri_converter'];
        }
        $g = ($container->privates['api_platform.symfony.iri_converter.skolem'] ?? self::getApiPlatform_Symfony_IriConverter_SkolemService($container));

        if (isset($container->privates['api_platform.symfony.iri_converter'])) {
            return $container->privates['api_platform.symfony.iri_converter'];
        }
        $h = ($container->privates['api_platform.metadata.operation.metadata_factory'] ?? self::getApiPlatform_Metadata_Operation_MetadataFactoryService($container));
        ...
        return $container->privates['api_platform.symfony.iri_converter'] = new \ApiPlatform\Symfony\Routing\IriConverter($a, $b, new \ApiPlatform\Metadata\IdentifiersExtractor($c, $i, $d, $e, ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container))), $i, $c, $f, $g, $h);
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $k = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, $container->parameters['api_platform.serializer.default_context']);

        $l = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $i, $a)], [$k])), $container->parameters['api_platform.serializer.default_context']), $container->parameters['api_platform.serializer.default_context']);
        $m = ($container->privates['api_platform.hydra.name_converter.hydra_prefix'] ?? self::getApiPlatform_Hydra_NameConverter_HydraPrefixService($container));
        ...
        $p = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $d, $e, $n, $f, $i, $m, $o, $container->parameters['api_platform.serializer.default_context'], $g, NULL);

        $q = new \ApiPlatform\JsonLd\Serializer\ErrorNormalizer($p, $container->parameters['api_platform.serializer.default_context']);
        $r = new \ApiPlatform\Serializer\ItemNormalizer($c, $d, $e, $n, $i, $m, $o, NULL, $b, $g, [], NULL);
        ...
        $v = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $t, $i, $a, $u, NULL, $container->parameters['api_platform.serializer.default_context'], $a);
        ...
        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($i), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($l, $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($l, $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $m), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $m, $container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($l, $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($q, $m), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $d, $n, $h, $m, $container->parameters['api_platform.serializer.default_context'], true), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $e, $h), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $m), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($q, $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, $container->parameters['api_platform.serializer.default_context'], $s), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($p, $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($r, $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $t), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($o, $t, $a, $u, NULL, [])), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($s, $container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($f, $n, $e, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $b, $i, 1, $container->parameters['api_platform.serializer.default_context']), $b, $n, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), $container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($v, $e, $f), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($v, $j, 'default')], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder($k, $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder($w, $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $w), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $j, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $j, 'default')], $container->parameters['api_platform.serializer.default_context']), $j, 'default');
    }
