...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator..Yk_xJf'] ?? self::get_ServiceLocator__YkXJfService($container)), ($container->privates['.service_locator.8_qPj7R'] ?? $container->load('get_ServiceLocator_8QPj7RService')), ['api' => [($container->privates['debug.security.authenticator.jwt.api'] ?? $container->load('getDebug_Security_Authenticator_Jwt_ApiService')), ($container->privates['debug.security.authenticator.json_login.api'] ?? $container->load('getDebug_Security_Authenticator_JsonLogin_ApiService'))], 'main' => [($container->privates['debug.security.authenticator.form_login.main'] ?? $container->load('getDebug_Security_Authenticator_FormLogin_MainService'))]], false);
