 ...
 */
class getDetailsSectionImageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetailsSectionImageRepository' shared autowired service.
     *
     * @return \App\Repository\DetailsSectionImageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetailsSectionImageRepository.php';

        return $container->privates['App\\Repository\\DetailsSectionImageRepository'] = new \App\Repository\DetailsSectionImageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
