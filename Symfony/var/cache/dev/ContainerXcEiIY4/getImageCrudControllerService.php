...
class getImageCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'ImageUploader.php';
        ...
        $container->services['App\\Controller\\Admin\\ImageCrudController'] = $instance = new \App\Controller\Admin\ImageCrudController(new \App\Service\ImageUploader((\dirname(__DIR__, 4).'/public/uploads'), ($container->privates['slugger'] ??= new \Symfony\Component\String\Slugger\AsciiSlugger('en'))));

        $instance->setContainer(($container->privates['.service_locator.OkS5_e6'] ?? $container->load('get_ServiceLocator_OkS5E6Service'))->withContext('App\\Controller\\Admin\\ImageCrudController', $container));
