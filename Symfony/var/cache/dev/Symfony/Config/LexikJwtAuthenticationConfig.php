...
class LexikJwtAuthenticationConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
    public function accessTokenIssuance(array $value = []): \Symfony\Config\LexikJwtAuthentication\AccessTokenIssuanceConfig
    {
        if (null === $this->accessTokenIssuance) {
    ...
    */
    public function accessTokenVerification(array $value = []): \Symfony\Config\LexikJwtAuthentication\AccessTokenVerificationConfig
    {
        if (null === $this->accessTokenVerification) {
    ...
    */
    public function blocklistToken(array $value = []): \Symfony\Config\LexikJwtAuthentication\BlocklistTokenConfig
    {
        if (null === $this->blocklistToken) {
