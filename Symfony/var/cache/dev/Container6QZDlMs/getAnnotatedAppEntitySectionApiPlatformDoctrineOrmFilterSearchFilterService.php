 ...
 */
class getAnnotatedAppEntitySectionApiPlatformDoctrineOrmFilterSearchFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_section_api_platform_doctrine_orm_filter_search_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['annotated_app_entity_section_api_platform_doctrine_orm_filter_search_filter'])) {
            return $container->privates['annotated_app_entity_section_api_platform_doctrine_orm_filter_search_filter'];
        }
