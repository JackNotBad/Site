...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminRouteGenerator'] = new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteGenerator(new RewindableGenerator(function () use ($container) {
            ...
            yield 0 => ($container->services['App\\Controller\\Admin\\CarouselImageCrudController'] ?? $container->load('getCarouselImageCrudControllerService'));
            yield 1 => ($container->services['App\\Controller\\Admin\\ImageCrudController'] ?? $container->load('getImageCrudControllerService'));
            yield 2 => ($container->services['App\\Controller\\Admin\\MessageCrudController'] ?? $container->load('getMessageCrudControllerService'));
            yield 3 => ($container->services['App\\Controller\\Admin\\PriceListCrudController'] ?? $container->load('getPriceListCrudControllerService'));
            yield 4 => ($container->services['App\\Controller\\Admin\\SectionCrudController'] ?? $container->load('getSectionCrudControllerService'));
            yield 5 => ($container->services['App\\Controller\\Admin\\SliderCrudController'] ?? $container->load('getSliderCrudControllerService'));
            yield 6 => ($container->services['App\\Controller\\Admin\\UserCrudController'] ?? $container->load('getUserCrudControllerService'));
        }, 7), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), $container->targetDir.'', 'en', new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    }
