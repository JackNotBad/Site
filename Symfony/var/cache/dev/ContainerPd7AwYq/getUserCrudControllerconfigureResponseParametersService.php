...
class getUserCrudControllerconfigureResponseParametersService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->privates['.service_locator.ib1WIGE.App\\Controller\\Admin\\UserCrudController::configureResponseParameters()'] = (new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
