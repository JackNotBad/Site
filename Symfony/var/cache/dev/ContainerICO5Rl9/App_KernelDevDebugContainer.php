...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\CarouselCrudController' => 'getCarouselCrudControllerService',
            'App\\Controller\\Admin\\CarouselImageCrudController' => 'getCarouselImageCrudControllerService',
            'App\\Controller\\Admin\\DashboardController' => 'getDashboardControllerService',
            'App\\Controller\\Admin\\DetailsSectionImageCrudController' => 'getDetailsSectionImageCrudControllerService',
            ...
            'App\\Controller\\Admin\\PriceListCrudController' => 'getPriceListCrudControllerService',
            ...
            'App\\Controller\\Admin\\SliderImageCrudController' => 'getSliderImageCrudControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'hydra'.\DIRECTORY_SEPARATOR.'State'.\DIRECTORY_SEPARATOR.'Util'.\DIRECTORY_SEPARATOR.'SearchHelperTrait.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'hydra'.\DIRECTORY_SEPARATOR.'State'.\DIRECTORY_SEPARATOR.'Util'.\DIRECTORY_SEPARATOR.'PaginationHelperTrait.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Resource'.\DIRECTORY_SEPARATOR.'Factory'.\DIRECTORY_SEPARATOR.'PhpFileResourceNameCollectionFactory.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Extractor'.\DIRECTORY_SEPARATOR.'PhpFileResourceExtractor.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Resource'.\DIRECTORY_SEPARATOR.'Factory'.\DIRECTORY_SEPARATOR.'MutatorResourceMetadataCollectionFactory.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Mutator'.\DIRECTORY_SEPARATOR.'ResourceMutatorCollectionInterface.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Mutator'.\DIRECTORY_SEPARATOR.'ResourceResourceMutatorCollection.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Mutator'.\DIRECTORY_SEPARATOR.'OperationMutatorCollectionInterface.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Mutator'.\DIRECTORY_SEPARATOR.'OperationResourceMutatorCollection.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Resource'.\DIRECTORY_SEPARATOR.'Factory'.\DIRECTORY_SEPARATOR.'PhpFileResourceMetadataCollectionFactory.php';
    ...
    {
        return $container->services['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CWquifWLAU', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QV-QTkpowN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z1N98Kik3q', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.openapi'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M8V6C+Ki3q', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eWn836mOYl', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8gPq39KINo', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.easyadmin'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Qu+hcGS3N7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DyBLCbQF3e', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WYW2va2BSB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P0OYxEiFOK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ao8utCbU2K', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    /**
     * Gets the private '.service_locator..Yk_xJf' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator__YkXJfService($container)
    {
        return $container->privates['.service_locator..Yk_xJf'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    protected static function getAdminRouterSubscriberService($container)
    {
        ...
        $d = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry(['App\\Controller\\Admin\\CarouselCrudController' => 'App\\Entity\\Carousel', 'App\\Controller\\Admin\\CarouselImageCrudController' => 'App\\Entity\\CarouselImage', 'App\\Controller\\Admin\\DetailsSectionImageCrudController' => 'App\\Entity\\DetailsSectionImage', 'App\\Controller\\Admin\\ImageCrudController' => 'App\\Entity\\Image', 'App\\Controller\\Admin\\MessageCrudController' => 'App\\Entity\\Message', 'App\\Controller\\Admin\\PageCrudController' => 'App\\Entity\\Page', 'App\\Controller\\Admin\\PriceListCrudController' => 'App\\Entity\\PriceList', 'App\\Controller\\Admin\\SectionCrudController' => 'App\\Entity\\Section', 'App\\Controller\\Admin\\SliderCrudController' => 'App\\Entity\\Slider', 'App\\Controller\\Admin\\SliderImageCrudController' => 'App\\Entity\\SliderImage', 'App\\Controller\\Admin\\UserCrudController' => 'App\\Entity\\User'], ['App\\Controller\\Admin\\CarouselCrudController' => '5727e87', 'App\\Controller\\Admin\\CarouselImageCrudController' => '7bbfa9f', 'App\\Controller\\Admin\\DetailsSectionImageCrudController' => '8a0b38d', 'App\\Controller\\Admin\\ImageCrudController' => '06d9db2', 'App\\Controller\\Admin\\MessageCrudController' => '8b3c783', 'App\\Controller\\Admin\\PageCrudController' => 'd06b327', 'App\\Controller\\Admin\\PriceListCrudController' => '2603e95', 'App\\Controller\\Admin\\SectionCrudController' => '7c5a3e4', 'App\\Controller\\Admin\\SliderCrudController' => '3482975', 'App\\Controller\\Admin\\SliderImageCrudController' => 'a1581c0', 'App\\Controller\\Admin\\UserCrudController' => 'e258ef6'], ['App\\Entity\\Carousel' => 'App\\Controller\\Admin\\CarouselCrudController', 'App\\Entity\\CarouselImage' => 'App\\Controller\\Admin\\CarouselImageCrudController', 'App\\Entity\\DetailsSectionImage' => 'App\\Controller\\Admin\\DetailsSectionImageCrudController', 'App\\Entity\\Image' => 'App\\Controller\\Admin\\ImageCrudController', 'App\\Entity\\Message' => 'App\\Controller\\Admin\\MessageCrudController', 'App\\Entity\\Page' => 'App\\Controller\\Admin\\PageCrudController', 'App\\Entity\\PriceList' => 'App\\Controller\\Admin\\PriceListCrudController', 'App\\Entity\\Section' => 'App\\Controller\\Admin\\SectionCrudController', 'App\\Entity\\Slider' => 'App\\Controller\\Admin\\SliderCrudController', 'App\\Entity\\SliderImage' => 'App\\Controller\\Admin\\SliderImageCrudController', 'App\\Entity\\User' => 'App\\Controller\\Admin\\UserCrudController'], ['5727e87' => 'App\\Controller\\Admin\\CarouselCrudController', '7bbfa9f' => 'App\\Controller\\Admin\\CarouselImageCrudController', '8a0b38d' => 'App\\Controller\\Admin\\DetailsSectionImageCrudController', '06d9db2' => 'App\\Controller\\Admin\\ImageCrudController', '8b3c783' => 'App\\Controller\\Admin\\MessageCrudController', 'd06b327' => 'App\\Controller\\Admin\\PageCrudController', '2603e95' => 'App\\Controller\\Admin\\PriceListCrudController', '7c5a3e4' => 'App\\Controller\\Admin\\SectionCrudController', 3482975 => 'App\\Controller\\Admin\\SliderCrudController', 'a1581c0' => 'App\\Controller\\Admin\\SliderImageCrudController', 'e258ef6' => 'App\\Controller\\Admin\\UserCrudController']);
    ...
    protected static function getEntityFactoryService($container)
    {
        ...
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\EntityFactory'] = new \EasyCorp\Bundle\EasyAdminBundle\Factory\EntityFactory(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Security\\AuthorizationChecker'] ?? self::getAuthorizationCheckerService($container)), ($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminRouteGenerator'] = new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteGenerator(new RewindableGenerator(function () use ($container) {
            ...
            yield 0 => ($container->services['App\\Controller\\Admin\\CarouselCrudController'] ?? $container->load('getCarouselCrudControllerService'));
            yield 1 => ($container->services['App\\Controller\\Admin\\CarouselImageCrudController'] ?? $container->load('getCarouselImageCrudControllerService'));
            yield 2 => ($container->services['App\\Controller\\Admin\\DetailsSectionImageCrudController'] ?? $container->load('getDetailsSectionImageCrudControllerService'));
            yield 3 => ($container->services['App\\Controller\\Admin\\ImageCrudController'] ?? $container->load('getImageCrudControllerService'));
            yield 4 => ($container->services['App\\Controller\\Admin\\MessageCrudController'] ?? $container->load('getMessageCrudControllerService'));
            yield 5 => ($container->services['App\\Controller\\Admin\\PageCrudController'] ?? $container->load('getPageCrudControllerService'));
            yield 6 => ($container->services['App\\Controller\\Admin\\PriceListCrudController'] ?? $container->load('getPriceListCrudControllerService'));
            yield 7 => ($container->services['App\\Controller\\Admin\\SectionCrudController'] ?? $container->load('getSectionCrudControllerService'));
            yield 8 => ($container->services['App\\Controller\\Admin\\SliderCrudController'] ?? $container->load('getSliderCrudControllerService'));
            yield 9 => ($container->services['App\\Controller\\Admin\\SliderImageCrudController'] ?? $container->load('getSliderImageCrudControllerService'));
            yield 10 => ($container->services['App\\Controller\\Admin\\UserCrudController'] ?? $container->load('getUserCrudControllerService'));
        }, 11), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), $container->targetDir.'', 'en', new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    }
    ...
    protected static function getAdminUrlGeneratorService($container)
    {
        $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator'] = function ($container) {
            ...
            return new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminUrlGenerator(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $a, ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\DashboardControllerRegistry'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Registry\DashboardControllerRegistry($container->targetDir.'', ['App\\Controller\\Admin\\DashboardController' => '3fb43d7'], ['3fb43d7' => 'App\\Controller\\Admin\\DashboardController'])), $b, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)));
        };
    ...
    protected static function getApiPlatform_FilterLocatorService($container)
    {
        return $container->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'annotated_app_entity_carousel_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_carousel_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityCarouselApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_details_section_image_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_details_section_image_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityDetailsSectionImageApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_page_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_page_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityPageApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_section_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_section_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntitySectionApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_slider_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_slider_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntitySliderApiPlatformDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_carousel_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_details_section_image_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_page_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_section_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_slider_api_platform_doctrine_orm_filter_search_filter' => '?',
        ]);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('elECF2s+ti', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0DWybh1xBS', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TY9hBJ1pcG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b0QjXYLFWX', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ADLKxGFbZ5', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.ux.twig_component'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('h2BrZkmkzr', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9eksacCSF3', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\CarouselCrudController', 'App\\Controller\\Admin\\CarouselImageCrudController', 'App\\Controller\\Admin\\DashboardController', 'App\\Controller\\Admin\\DetailsSectionImageCrudController', 'App\\Controller\\Admin\\ImageCrudController', 'App\\Controller\\Admin\\MessageCrudController', 'App\\Controller\\Admin\\PageCrudController', 'App\\Controller\\Admin\\PriceListCrudController', 'App\\Controller\\Admin\\SectionCrudController', 'App\\Controller\\Admin\\SliderCrudController', 'App\\Controller\\Admin\\SliderImageCrudController', 'App\\Controller\\Admin\\UserCrudController', 'App\\Controller\\HomeController', 'App\\Controller\\LoginController', 'App\\Controller\\SigninController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $l = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, $container->parameters['api_platform.serializer.default_context']);

        $m = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $j, $a)], [$l])), $container->parameters['api_platform.serializer.default_context']), $container->parameters['api_platform.serializer.default_context']);
        $n = ($container->privates['api_platform.hydra.name_converter.hydra_prefix'] ?? self::getApiPlatform_Hydra_NameConverter_HydraPrefixService($container));
        $o = ($container->privates['api_platform.resource_class_resolver'] ?? self::getApiPlatform_ResourceClassResolverService($container));
        $p = ($container->privates['api_platform.serializer.mapping.class_metadata_factory'] ?? self::getApiPlatform_Serializer_Mapping_ClassMetadataFactoryService($container));

        $q = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $d, $e, $o, $f, $j, $n, $p, $container->parameters['api_platform.serializer.default_context'], $g, NULL);

        $r = new \ApiPlatform\JsonLd\Serializer\ErrorNormalizer($q, $container->parameters['api_platform.serializer.default_context']);
        $s = new \ApiPlatform\Serializer\ItemNormalizer($c, $d, $e, $o, $j, $n, $p, NULL, $b, $g, [], NULL);
        ...
        $v = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($p);
        $w = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($p, $u, $j, $a, $v, NULL, $container->parameters['api_platform.serializer.default_context'], $a);
        ...
        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($j), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($m, $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($m, $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $n), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $n, $container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($m, $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $n), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $d, $o, $h, $n, $container->parameters['api_platform.serializer.default_context'], true), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $e, $h), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($s, $n), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($r, $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, $container->parameters['api_platform.serializer.default_context'], $t), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($q, $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($s, $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $u), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($p, $u, $a, $v, NULL, [])), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($t, $container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($f, $o, $e, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $b, $j, 1, $container->parameters['api_platform.serializer.default_context']), $b, $o, $i, $container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($w, $e, $f), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($w, $k, 'default')], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder($l, $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder($x, $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $x), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $k, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $k, 'default')], $container->parameters['api_platform.serializer.default_context']), $k, 'default');
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\DetailsSectionImageRepository' => ['privates', 'App\\Repository\\DetailsSectionImageRepository', 'getDetailsSectionImageRepositoryService', true],
            ...
            'App\\Repository\\SliderImageRepository' => ['privates', 'App\\Repository\\SliderImageRepository', 'getSliderImageRepositoryService', true],
            ...
            'App\\Repository\\DetailsSectionImageRepository' => '?',
            ...
            'App\\Repository\\SliderImageRepository' => '?',
    ...
    {
        $a = ($container->privates['.service_locator..Yk_xJf'] ?? self::get_ServiceLocator__YkXJfService($container));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Validator\\Constraints\\ImagesCountValidator' => ['privates', 'App\\Validator\\Constraints\\ImagesCountValidator', 'getImagesCountValidatorService', true],
            ...
            'App\\Validator\\Constraints\\ImagesCountValidator' => '?',
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'nelmio_cors.map' => [
                '^/api/' => [
                    'allow_origin' => [
                        0 => 'https://mon-front.example:3000',
                    ],
                    'allow_headers' => [
                        0 => 'content-type',
                        1 => 'authorization',
            ...
            'api_platform.class_name_resources' => [
                ...
                2 => 'App\\Entity\\Carousel',
                3 => 'App\\Entity\\CarouselImage',
                4 => 'App\\Entity\\DetailsSectionImage',
                5 => 'App\\Entity\\Image',
                6 => 'App\\Entity\\Message',
                7 => 'App\\Entity\\Page',
                8 => 'App\\Entity\\PriceList',
                9 => 'App\\Entity\\Section',
                10 => 'App\\Entity\\Slider',
                11 => 'App\\Entity\\SliderImage',
                12 => 'App\\Entity\\User',
            ],
