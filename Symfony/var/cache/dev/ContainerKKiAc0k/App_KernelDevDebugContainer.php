...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getAdminRouterSubscriberService($container)
    {
        ...
        $d = ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Security\\AuthorizationChecker'] ?? self::getAuthorizationCheckerService($container));
        $e = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry([], [], [], []);
        $f = ($container->privates['debug.controller_resolver'] ?? self::getDebug_ControllerResolverService($container));

        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\EventListener\\AdminRouterSubscriber'] = new \EasyCorp\Bundle\EasyAdminBundle\EventListener\AdminRouterSubscriber(new \EasyCorp\Bundle\EasyAdminBundle\Factory\AdminContextFactory($container->targetDir.'', ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Factory\MenuFactory(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $d, ($container->privates['security.logout_url_generator'] ?? self::getSecurity_LogoutUrlGeneratorService($container)), (isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Menu\MenuItemMatcher((isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), $a), $b), $e, new \EasyCorp\Bundle\EasyAdminBundle\Factory\EntityFactory($d, ($container->services['doctrine'] ?? self::getDoctrineService($container)), $c), $a), new \EasyCorp\Bundle\EasyAdminBundle\Factory\ControllerFactory($f), $f, $b, $b, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), $a, $container->targetDir.'', $e);
    }
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        ...
        }, 1), new RewindableGenerator(fn () => new \EmptyIterator(), 0), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), $container->targetDir.'', 'en', new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\DashboardController', 'App\\Controller\\HomeController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
