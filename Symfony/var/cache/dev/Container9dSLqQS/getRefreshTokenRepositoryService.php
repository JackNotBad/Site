...
class getRefreshTokenRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RefreshTokenRepository.php';

        return $container->privates['App\\Repository\\RefreshTokenRepository'] = new \App\Repository\RefreshTokenRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
