...
class __TwigTemplate_e543988adbaea463ce393997dff0ec84 extends Template
{
...
/* @EasyAdmin/crud/action.html.twig */
class __TwigTemplate_e543988adbaea463ce393997dff0ec84___33184894721 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["outerScope"]) || array_key_exists("outerScope", $context) ? $context["outerScope"] : (function () { throw new RuntimeError('Variable "outerScope" does not exist.', 6, $this->source); })()), "action", [], "any", false, false, false, 6), "label", [], "any", false, false, false, 6))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield "<span class=\"action-label\">";
            yield $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["outerScope"]) || array_key_exists("outerScope", $context) ? $context["outerScope"] : (function () { throw new RuntimeError('Variable "outerScope" does not exist.', 6, $this->source); })()), "action", [], "any", false, false, false, 6), "label", [], "any", false, false, false, 6));
            yield "</span>";
        }
