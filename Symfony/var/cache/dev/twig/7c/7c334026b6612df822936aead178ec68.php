...
class __TwigTemplate_e97bd0f5672fdee4827faeece8cffdc9 extends Template
{
...
unset($context[$key]);
        ...
        yield "\"";
        if ((($tmp = (isset($context["morph"]) || array_key_exists("morph", $context) ? $context["morph"] : (function () { throw new RuntimeError('Variable "morph" does not exist.', 3, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield " method=\"morph\"";
        }
...
", "@Turbo/components/Stream/Replace.html.twig", "C:\\Users\\luffy\\OneDrive\\Dev\\Formation\\DevellopeurWeb\\FormationDWWM\\MSPR 2\\Site\\Symfony\\vendor\\symfony\\ux-turbo\\templates\\components\\Stream\\Replace.html.twig");
    }
}
